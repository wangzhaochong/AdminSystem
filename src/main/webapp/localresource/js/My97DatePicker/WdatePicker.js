...
(function() {
        var _ = {
            ...
            //特殊天
            disabledDates: null ,
            //无效日期 如：disabledDates:['5$']
            disabledDays: null ,
            //无效天 如：disabledDays:[6]
            opposite: false,
            //有效日期
            onpicking: null ,
            onpicked: null ,
        ...
        function K(H, $) {
            ...
            if (!$dp.dd || $dp.eCont || ($dp.lang && $dp.realLang && $dp.realLang.name != $dp.lang && $dp.getLangIndex && $dp.getLangIndex($dp.lang) >= 0)) {
                ...
                if (_.$dpPath == "")
                    F(A);
                var B = "<iframe style=\"width:1px;height:1px\" src=\"" + "\\localresource\\js\\My97DatePicker\\My97DatePicker.htm\" frameborder=\"0\" border=\"0\" scrolling=\"no\"></iframe>";
                if ($dp.eCont) {
